defmodule VenirDevWebsite.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddMagicLinkAuthExtensions1 do
  @moduledoc """
